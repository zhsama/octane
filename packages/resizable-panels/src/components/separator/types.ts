...
type DivProps = Omit<
	...
	'children' | 'className' | 'id' | 'ref' | 'role' | 'style' | 'tabIndex'
>;
type CSSProperties = Exclude<Octane.JSX.IntrinsicElements['div']['style'], string | undefined>;
