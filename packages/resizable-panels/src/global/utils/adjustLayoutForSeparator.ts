...
import { getMountedGroupState, updateMountedGroup } from '../mutable-state/groups';
...
export function adjustLayoutForSeparator(separatorElement: HTMLElement, delta: number) {
