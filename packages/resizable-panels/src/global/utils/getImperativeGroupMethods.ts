import type { GroupImperativeHandle, Layout } from '../../components/group/types';
...
export function getImperativeGroupMethods({ groupId }: { groupId: string }): GroupImperativeHandle {
	const find = () => {
